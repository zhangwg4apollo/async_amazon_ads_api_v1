---
title: Product relevance (Product)
description: Product relevance (Product)
type: guide
interface: api
tags:
  - Reporting
...
The Product relevance dimension contains 1 field, listed below:

## Product relevance (Primary Key)

- **Reporting Field ID**: `productRelevance.value`
- **Data Type**: `STRING`
- **Description**: Indicates whether the product was directly promoted in the campaign or attributed based on relevance to promoted products (halo).
- **Required fields**: N/A
