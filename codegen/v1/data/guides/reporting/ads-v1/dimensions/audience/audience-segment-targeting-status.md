---
title: Audience segment targeting status (Audience)
description: Audience segment targeting status (Audience)
type: guide
interface: api
tags:
  - Reporting
...
# Audience segment targeting status (Audience)

The Audience segment targeting status dimension contains 1 field, listed below:

## Audience segment targeting status (Primary Key)

- **Reporting Field ID**: `audienceSegmentTargetingStatus.value`
- **Data Type**: `STRING`
- **Description**: The targeting status of the audience segment when the impression was delivered.
- **Required fields**: N/A
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: `segmentStatus`
