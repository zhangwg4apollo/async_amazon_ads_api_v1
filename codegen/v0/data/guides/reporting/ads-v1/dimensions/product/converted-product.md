---
title: Converted product (Product)
description: Converted product (Product)
type: guide
interface: api
tags:
  - Reporting
...
The Converted product dimension contains 7 fields, listed below:

## Converted product ID (Primary Key)

- **Reporting Field ID**: `convertedProduct.id`
- **Data Type**: `STRING`
- **Description**: The unique identifier of the product attributed to the ad.
- **Required fields**: `convertedProductMarketplace.value` [📎](guides/reporting/ads-v1/dimensions/product/converted-product-marketplace#converted-product-marketplace-primary-key)
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: `convertedAsin`
- **Version 3 Reporting Name (Sponsored Ads)**: `purchasedAsin`

## Converted product name

- **Reporting Field ID**: `convertedProduct.name`
- **Data Type**: `STRING`
- **Description**: The display name of the product attributed to the ad.
- **Required fields**: `convertedProduct.id` [📎](guides/reporting/ads-v1/dimensions/product/converted-product#converted-product-id-primary-key)
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: `convertedProductName`
- **Version 3 Reporting Name (Sponsored Ads)**: `productName`

## Converted product parent ID

- **Reporting Field ID**: `convertedProduct.parentProductId`
- **Data Type**: `STRING`
- **Description**: The parent product identifier of the attributed product, used to group related product variations (if applicable).
- **Required fields**: `convertedProduct.id` [📎](guides/reporting/ads-v1/dimensions/product/converted-product#converted-product-id-primary-key)
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: `parentAsin`
- **Version 3 Reporting Name (Sponsored Ads)**: `parentAsin`

## Converted product brand

- **Reporting Field ID**: `convertedProduct.brand`
- **Data Type**: `STRING`
- **Description**: The brand of the product attributed to the ad.
- **Required fields**: `convertedProduct.id` [📎](guides/reporting/ads-v1/dimensions/product/converted-product#converted-product-id-primary-key)
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: `brandName`
- **Version 3 Reporting Name (Sponsored Ads)**: N/A

## Converted product category

- **Reporting Field ID**: `convertedProduct.category`
- **Data Type**: `STRING`
- **Description**: The top-level category of the product attributed to the ad.
- **Required fields**: `convertedProduct.id` [📎](guides/reporting/ads-v1/dimensions/product/converted-product#converted-product-id-primary-key)
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: `productCategory`
- **Version 3 Reporting Name (Sponsored Ads)**: `productCategory`

## Converted product subcategory

- **Reporting Field ID**: `convertedProduct.subcategory`
- **Data Type**: `STRING`
- **Description**: The product subcategory of the product attributed to the ad.
- **Required fields**: `convertedProduct.id` [📎](guides/reporting/ads-v1/dimensions/product/converted-product#converted-product-id-primary-key)
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: `productSubcategory`
- **Version 3 Reporting Name (Sponsored Ads)**: `productSubcategory`

## Converted product group

- **Reporting Field ID**: `convertedProduct.productGroup`
- **Data Type**: `STRING`
- **Description**: The product classification assigned to the attributed product for accounting and reporting purposes. Contains product categories.
- **Required fields**: `convertedProduct.id` [📎](guides/reporting/ads-v1/dimensions/product/converted-product#converted-product-id-primary-key)
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: `productGroup`
- **Version 3 Reporting Name (Sponsored Ads)**: `productGroup`
