---
title: Conversion source environment (Conversion)
description: Conversion source environment (Conversion)
type: guide
interface: api
tags:
  - Reporting
...
# Conversion source environment (Conversion)

The Conversion source environment dimension contains 1 field, listed below:

## Conversion source environment (Primary Key)

- **Reporting Field ID**: `conversionSourceEnvironment.value`
- **Data Type**: `STRING`
- **Description**: The environment used by the shopper to view the ad like web or app.
- **Required fields**: N/A
