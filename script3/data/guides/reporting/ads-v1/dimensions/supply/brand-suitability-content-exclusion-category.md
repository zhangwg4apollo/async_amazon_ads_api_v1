---
title: Brand suitability content exclusion category (Supply)
description: Brand suitability content exclusion category (Supply)
type: guide
interface: api
tags:
  - Reporting
...
# Brand suitability content exclusion category (Supply)

The Brand suitability content exclusion category dimension contains 1 field, listed below:

## Brand suitability content exclusion category (Primary Key)

- **Reporting Field ID**: `brandSuitabilityContentExclusionCategory.value`
- **Data Type**: `STRING`
- **Description**: The content exclusion category applied to opt out of specific topics that don't align with brand values.
- **Required fields**: N/A
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: `contentCategory (dspBrandSuitability)`
