---
title: Conversion source attribution type (Conversion)
description: Conversion source attribution type (Conversion)
type: guide
interface: api
tags:
  - Reporting
...
# Conversion source attribution type (Conversion)

The Conversion source attribution type dimension contains 1 field, listed below:

## Conversion source attribution type (Primary Key)

- **Reporting Field ID**: `conversionSourceAttributionType.value`
- **Data Type**: `STRING`
- **Description**: The organization whose attribution logic is applied to the conversions.
- **Required fields**: N/A
