---
title: Conversion type (off-Amazon) (Conversion)
description: Conversion type (off-Amazon) (Conversion)
type: guide
interface: api
tags:
  - Reporting
...
# Conversion type (off-Amazon) (Conversion)

The Conversion type (off-Amazon) dimension contains 1 field, listed below:

## Conversion type (off-Amazon) (Primary Key)

- **Reporting Field ID**: `offAmazonConversionType.value`
- **Data Type**: `STRING`
- **Description**: The type of the conversion defined by Amazon Ads to represent common shopping events used to measure the success of campaigns on and off Amazon.
- **Required fields**: `conversionSourceEnvironment.value` [📎](guides/reporting/ads-v1/dimensions/conversion/conversion-source-environment#conversion-source-environment-primary-key), `offAmazonConversionDefinition.value` [📎](guides/reporting/ads-v1/dimensions/conversion/conversion-definition-off-amazon#conversion-definition-off-amazon-primary-key)
