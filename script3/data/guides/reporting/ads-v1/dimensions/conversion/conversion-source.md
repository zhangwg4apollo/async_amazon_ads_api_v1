---
title: Conversion source (Conversion)
description: Conversion source (Conversion)
type: guide
interface: api
tags:
  - Reporting
...
The Conversion source dimension contains 3 fields, listed below:

## Conversion source (Primary Key)

- **Reporting Field ID**: `conversionSource.name`
- **Data Type**: `STRING`
- **Description**: The system or integration that reported conversions to Amazon Ads.
- **Required fields**: N/A
...
- **Reporting Field ID**: `conversionSource.owner`
- **Data Type**: `STRING`
- **Description**: The entity that oversees how conversions from this source are collected and reported.
- **Required fields**: `conversionSource.name` [📎](guides/reporting/ads-v1/dimensions/conversion/conversion-source#conversion-source-primary-key)
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: N/A
- **Version 3 Reporting Name (Sponsored Ads)**: N/A
...
- **Reporting Field ID**: `conversionSource.scaled`
- **Data Type**: `STRING`
- **Description**: This indicates whether the conversion was scaled by the source to represent a larger population.
- **Required fields**: `conversionSource.name` [📎](guides/reporting/ads-v1/dimensions/conversion/conversion-source#conversion-source-primary-key)
- **Complementary fields**: N/A
- **Version 3 Reporting Name (DSP)**: N/A
- **Version 3 Reporting Name (Sponsored Ads)**: N/A
